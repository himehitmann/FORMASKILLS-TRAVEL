...
| **Chercheur de contacts** | 🔎 Devine les emails (nom + domaine, 12 modèles classés par probabilité) · 📋 Extrait **tous** les contacts d'une page collée (emails, téléphones, sites, réseaux) — hors LinkedIn, site par site · 🧠 Apprend le modèle d'email d'une boîte à partir d'un seul email connu · ✔️ Vérifie (syntaxe, jetable, générique, format pro) · 💾 Carnet de contacts + export CSV. |
